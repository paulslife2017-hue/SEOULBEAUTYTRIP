...
/* 구글맵 좌상단 "View on Google Maps" 링크 차단 오버레이 */
.m-map::before{content:'';position:absolute;top:0;left:0;width:160px;height:40px;z-index:4;background:transparent;pointer-events:none}
.m-map-cover{position:absolute;top:0;left:0;width:160px;height:40px;z-index:4;background:rgba(8,8,14,.85);backdrop-filter:blur(4px);border-bottom-right-radius:10px;pointer-events:all;cursor:default}
