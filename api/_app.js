...
var GA4_SA_KEY_B64 = "";
var GA4_SA_KEY_DEFAULT = typeof atob !== "undefined" ? atob(GA4_SA_KEY_B64) : Buffer.from(GA4_SA_KEY_B64, "base64").toString();
var _cachedSql = null;
var _cachedUrl = "";
var getDb = (env) => {
...
async function initDb(env) {
  ...
  try {
    ...
    try {
      await sql`CREATE INDEX IF NOT EXISTS idx_ve_session ON visitor_events(session_id)`;
    } catch (e) {
    }
    try {
      await sql`CREATE INDEX IF NOT EXISTS idx_ve_visitor ON visitor_events(visitor_id)`;
    } catch (e) {
    }
    try {
      await sql`CREATE INDEX IF NOT EXISTS idx_ve_created ON visitor_events(created_at DESC)`;
    } catch (e) {
    }
    ...
    try {
      await sql`CREATE INDEX IF NOT EXISTS idx_vs_visitor ON visitor_sessions(visitor_id)`;
    } catch (e) {
    }
    try {
      await sql`CREATE INDEX IF NOT EXISTS idx_vs_started ON visitor_sessions(started_at DESC)`;
    } catch (e) {
    }
...
async function genVideoTags(video, shop, apiKey) {
  if (!apiKey) return [];
  const shopName = shop?.name || video.title || "Seoul Beauty";
  const category = shop?.category || "";
  ...
  const areaTag = "#" + location.replace(/\s+/g, "");
...
app.post("/api/shops/fill-seo-bulk", async (c) => {
  ...
  const rows = forceAll ? await sql`SELECT * FROM shops WHERE active=true` : await sql`SELECT * FROM shops WHERE active=true AND (
  ...
  for (const row of rows) {
    ...
    try {
      ...
      const _catLbl5 = { clinic: "aesthetic & skin clinic", skincare: "skincare clinic", hair: "hair salon", headspa: "head spa", tattoo: "permanent makeup studio", makeup: "color analysis studio", dental: "dental clinic" };
...
app.post("/api/videos/gen-description-bulk", async (c) => {
  ...
  const body = await c.req.json().catch(() => ({}));
  const forceAll = body?.force === true;
  const rows = forceAll ? await sql`SELECT v.*, s.name as shop_name, s.category as shop_cat, s.location as shop_loc, s.services as shop_svcs FROM videos v LEFT JOIN shops s ON v.shop_id=s.id` : await sql`SELECT v.*, s.name as shop_name, s.category as shop_cat, s.location as shop_loc, s.services as shop_svcs FROM videos v LEFT JOIN shops s ON v.shop_id=s.id WHERE (v.description IS NULL OR v.description='') OR (v.tags IS NULL OR v.tags='[]' OR v.tags='')`;
...
app.get("/api/visitors/:sessionId", async (c) => {
  ...
  try {
    ...
    const sessionNorm = session[0] ? {
      sessionId: session[0].session_id || session[0].sessionId || "",
      visitorId: session[0].visitor_id || session[0].visitorId || "",
      device: session[0].device || "desktop",
      country: session[0].country || "",
      referrer: session[0].referrer || "",
      ua: session[0].ua || "",
      startedAt: session[0].started_at || session[0].startedAt || "",
      lastActive: session[0].last_active || session[0].lastActive || "",
      pageCount: +(session[0].page_count || session[0].pageCount || 0),
      maxScroll: +(session[0].max_scroll || session[0].maxScroll || 0),
      durationSec: +(session[0].duration_sec || 0),
      waClicked: !!(session[0].wa_clicked || session[0].waClicked)
    } : null;
    const pageSummaryNorm = pageSummary.map((p) => ({
      page: p.page || "/",
      views: +(p.views || 0),
...
<div class="sp-wrap">
  ...
  ${(() => {
    ...
    const reviewCardsEnhanced = shopReviews2.map((rv, ri) => {
      ...
      const initials = (rv.author || "G").trim().split(" ").map((w) => w[0] || "").slice(0, 2).join("").toUpperCase() || "G";
      const avColor = avatarColors[ri % avatarColors.length];
      const hiddenClass = ri >= 3 ? " sp-rv-hidden" : "";
      return `<div class="sp-review-card${hiddenClass}"><div class="sp-review-avatar" style="background:${avColor}">${initials}</div><div class="sp-review-body"><div class="sp-review-top"><span class="sp-review-author">${rv.author || "Guest"}</span><span class="sp-review-stars">${rvStars}</span></div><div class="sp-review-text">${rv.text || ""}</div>` + (rv.time ? `<div class="sp-review-time">${rv.time}</div>` : "") + `</div></div>`;
    }).join("");
...
<footer class="gfooter">\xA9 ${yr} <a href="/">Seoul Beauty Trip</a> \u2014 Book Korean Beauty in Seoul for Foreigners</footer>
</body>
</html>`);
});
...
<main class="guide-wrap">
  ...
  <p>After a laser treatment, your skin may be slightly pink or sensitive. This is the ideal afternoon for a gentle neighbourhood stroll, caf\xE9-hopping, or exploring an indoor market. Apply the sunscreen and soothing essence provided by the clinic throughout the day.</p>
  <h3>Evening: K-Drama Caf\xE9 &amp; Skincare Research</h3>
  ...
  <p>Gangnam's Garosu-gil (tree-lined boulevard) is the perfect post-salon stroll: independent boutiques, design caf\xE9s, and excellent Korean restaurants within a 15-minute walk of the main beauty salon strip.</p>
...
<footer class="guide-footer">\xA9 ${yr} <a href="/">Seoul Beauty Trip</a> \u2014 Book Korean Beauty in Seoul for Foreigners &nbsp;|&nbsp; <a href="/guide">All Guides</a> &nbsp;|&nbsp; <a href="/blog">Blog</a></footer>
</body>
</html>`);
});
...
<main class="guide-wrap">
  ...
  <h2>\u{1F3E5} Korean Skin Clinic Treatments</h2>
  ...
  <h2>\u{1F487} Korean Hair Salon Treatments</h2>
...
app.get("/api/search-console/page-keywords", async (c) => {
  try {
    ...
    const siteUrl = "https://seoulbeautytrip.com";
    const token = await getGa4Token(saKey, "https://www.googleapis.com/auth/webmasters.readonly");
    const gscQuery = (body) => fetch(
      `https://searchconsole.googleapis.com/webmasters/v3/sites/${encodeURIComponent(siteUrl)}/searchAnalytics/query`,
      { method: "POST", headers: { Authorization: `Bearer ${token}`, "Content-Type": "application/json" }, body: JSON.stringify(body) }
    ).then((r) => r.json());
    const resQP = await gscQuery({ startDate, endDate, dimensions: ["query", "page"], rowLimit: 1e3, dataState: "all" });
    const allRows = resQP.rows || [];
    const filtered = allRows.filter((r) => r.keys[1] === pageUrl);
    let rows;
    if (filtered.length > 0) {
      ...
      for (const r of filtered) {
        ...
        if (ex) {
          ...
          queryMap.set(q, { clicks: r.clicks, impressions: r.impressions, position: r.position, count: 1 });
        }
      }
      rows = Array.from(queryMap.entries()).map(([q, v]) => ({ keys: [q], clicks: v.clicks, impressions: v.impressions, ctr: v.impressions > 0 ? v.clicks / v.impressions : 0, position: v.position / v.count })).sort((a, b) => b.impressions - a.impressions).slice(0, 25);
    } else {
...
.m-seo-block .sp-seo-h2{font-size:14px;font-weight:700;color:rgba(255,255,255,.88);margin:16px 0 8px 0;padding:10px 12px;background:rgba(232,65,122,.07);border-left:3px solid var(--pk2);border-radius:0 8px 8px 0;line-height:1.4}
.m-seo-block .sp-seo-h2:first-child{margin-top:0}
.m-seo-block .sp-seo-p{font-size:13px;color:rgba(255,255,255,.6);line-height:1.9;margin:0 0 14px;padding:0 2px}
.m-seo-block .sp-seo-p:last-child{margin-bottom:0}
.m-seo-block .sp-seo-p strong{color:rgba(255,255,255,.85);font-weight:600}
.m-seo-block .sp-seo-ul{margin:6px 0 16px 0;padding:0;list-style:none}
.m-seo-block .sp-seo-ul li{font-size:13px;color:rgba(255,255,255,.6);line-height:1.75;padding:5px 0 5px 20px;position:relative;border-bottom:1px solid rgba(255,255,255,.04)}
.m-seo-block .sp-seo-ul li:last-child{border-bottom:none}
.m-seo-block .sp-seo-ul li::before{content:'\u203A';position:absolute;left:6px;color:var(--pk2);font-weight:700}
...
<div class="tab-content" id="tab-shops">
  ...
  <div class="card" id="videoAddPanel" style="display:none;margin-bottom:16px;border:1px solid rgba(255,77,141,.35)">
    ...
    <div id="vd-drop-zone" onclick="document.getElementById('vd-file-input').click()"
      ...
      <div style="font-size:12px;color:rgba(255,255,255,.35)">MP4, MOV, AVI \uB4F1 \xB7 \uCD5C\uB300 500MB</div>
    </div>
...
function buildVsRow(s){
  ...
  if(fp === '/') { fpLabel = '\u{1F3E0} \uD648'; fpColor='rgba(255,255,255,.5)'; }
  ...
  return '<div class="vs-row" id="vsr-'+s.sessionId+'" data-sid="'+s.sessionId+'">'
    ...
    +'<span style="color:rgba(255,255,255,.15)">\xB7</span>'
...
window.toggleVsTimeline = async function(sid){
  ...
  try {
    ...
    var summaryHtml =
      ...
      +'<div style="font-size:10px"><span style="color:rgba(255,255,255,.3);font-size:9px">\u{1F4C4} </span><span style="color:#e2e8f0;font-weight:700">'+pgCount+'\uD398\uC774\uC9C0</span></div>'
      ...
      +'<div style="font-size:10px"><span style="color:rgba(255,255,255,.3);font-size:9px">\u{1F3EA} </span><span style="color:#e2e8f0;font-weight:700">'+shopViews+'\uD68C \uC870\uD68C</span></div>'
      +'</div></div>'
      // \uD558\uB2E8: \uD0DC\uADF8 \uD589 (\uC720\uC785\uACBD\uB85C \uD3EC\uD568)
...
window.loadAnalytics = async function loadAnalytics(days) {
  ...
  try {
    ...
    var NO_DATA = '<div style="color:rgba(255,255,255,.3);font-size:11px;padding:10px 0;text-align:center">\u{1F50D} \uC544\uC9C1 \uAC80\uC0C9 \uB178\uCD9C \uB370\uC774\uD130 \uC5C6\uC74C<br><span style="font-size:10px;opacity:.6">\uAD6C\uAE00 \uAC80\uC0C9\uC5D0 \uB178\uCD9C\uB418\uBA74 \uC790\uB3D9\uC73C\uB85C \uD45C\uC2DC\uB429\uB2C8\uB2E4</span></div>';
  ...
  try {
    ...
    if(rows.length === 0) {
      kwEl.innerHTML = '<div style="color:rgba(255,255,255,.35);text-align:center;padding:14px 10px;font-size:11px;line-height:1.6">'
        + '<div style="font-size:18px;margin-bottom:6px">\u{1F4CA}</div>'
        + '\uD0A4\uC6CC\uB4DC \uC138\uBD80 \uB370\uC774\uD130\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4<br>'
...
window.handleVideoFileSelect = function(input) {
  ...
  dropZone.innerHTML = '<i class="fas fa-check-circle" style="font-size:28px;color:#4ade80;margin-bottom:8px;display:block"></i>'
    ...
    + '<div style="font-size:11px;color:rgba(255,255,255,.35);margin-top:4px">' + (file.size/1024/1024).toFixed(1) + 'MB \xB7 \uD074\uB9AD\uD558\uBA74 \uB2E4\uC2DC \uC120\uD0DD</div>';
